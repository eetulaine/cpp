...
/*   Updated: 2025/07/24 18:10:17 by eelaine          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Bureaucrat {
	...
	public:
		...
		Bureaucrat &operator=(const Bureaucrat &other) = delete; //the name is const, we can't use a copy assignment operator for it
		~Bureaucrat();
